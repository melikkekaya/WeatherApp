...
"font: 75 24pt \"Times New Roman\";")
        ...
        self.main_lbl_gif = QtWidgets.QLabel(self.centralwidget)
        self.main_lbl_gif.setGeometry(QtCore.QRect(0, 0, 1001, 731))
        self.main_lbl_gif.setStyleSheet("")
        self.main_lbl_gif.setText("")
        self.main_lbl_gif.setObjectName("main_lbl_gif")
        self.main_lbl_gif.raise_()
        self.main_btn_search.raise_()
        self.main_lbl_mainheading.raise_()
        self.main_lbl_headingcity.raise_()
        self.main_lbl_showcityname.raise_()
        self.main_lbl_showweathericon.raise_()
        self.main_lbl_showtemperature.raise_()
        self.gridLayoutWidget.raise_()
        self.main_btn_exit.raise_()
        self.main_tbl_cities.raise_()
        self.main_linedit_city.raise_()
        self.main_btn_usa.raise_()
        self.main_btn_belgium.raise_()
        self.main_btn_germany.raise_()
        self.main_lbl_showweathersituation.raise_()
        self.main_btn_info.raise_()
        self.main_lbl_searchwarning.raise_()
