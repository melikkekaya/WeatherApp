...
class Main_Window(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.setupUi(self)
        self.movie = QMovie(":/newPrefix/giphy-3.gif")
        self.movie.setScaledSize(QSize(1500,750))
        self.main_lbl_gif.setMovie(self.movie)
        self.movie.start()
    ...
    def update_weather(self):
        ...
        try:
            ...
            if weather_code in sunny:
                movie1 = QMovie(":/newPrefix/sunny.gif")
                movie1.setScaledSize(QSize(1500,750))
                self.main_lbl_gif.setMovie(movie1)
                movie1.start()

            elif weather_code in thunder:
                movie1 = QMovie(":/newPrefix/thunder.gif")
                movie1.setScaledSize(QSize(1500,750))
                self.main_lbl_gif.setMovie(movie1)
                movie1.start()

            elif weather_code in rain:
                movie2 = QMovie(":/newPrefix/rain2.gif")
                movie2.setScaledSize(QSize(1500,750))
                self.main_lbl_gif.setMovie(movie2)
                movie2.start()
                
            elif weather_code in snow:
                movie3 = QMovie(":/newPrefix/snow.gif")
                movie3.setScaledSize(QSize(1500,750))
                self.main_lbl_gif.setMovie(movie3)
                movie3.start()
            elif weather_code in mist:
                movie4 = QMovie(":/newPrefix/mist.gif")
                movie4.setScaledSize(QSize(1500,750))
                self.main_lbl_gif.setMovie(movie4)
                movie4.start()
            else:
                movie5 = QMovie(":/newPrefix/giphy-3.gif")
                movie5.setScaledSize(QSize(1500,750))
                self.main_lbl_gif.setMovie(movie5)
                movie5.start()
